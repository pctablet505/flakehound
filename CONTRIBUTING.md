...
**one rule = one small file** — so your first PR can realistically land in about
30 minutes. This doc gets you from clone to green CI.
...
pyright src
pytest -p randomly -q
flakehound scan tests/            # we dogfood our own tool
```
